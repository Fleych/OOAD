...
{
    internal class StartStop : Element
    {
        public StartStop(Point pos, Size element_size, int border_size, Color color, string text)
        {
        ...
        protected override void Draw(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawEllipse(pen, this.border_size / 2 + 4, this.border_size / 2 + 4, this.hitbox.Size.Width - this.border_size - 8, this.hitbox.Size.Height - this.border_size - 8);
        }
        ...
        {
            return new StartStop(this.hitbox.Location, this.hitbox.Size, this.border_size, this.color, this.label.Text);
        }
    }
}
