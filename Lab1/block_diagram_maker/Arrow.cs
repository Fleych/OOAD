...
namespace block_diagram_maker
{
    ...
    {
        public Arrow(Point pos, Size element_size, int border_size, Color color, string text)
        {
        ...
        protected override void Draw(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(pen, 4, 4, this.hitbox.Size.Width - 4, this.hitbox.Size.Height - 4);
            pen.Width = this.border_size + 4;
            e.Graphics.DrawLine(pen, this.hitbox.Size.Width - 8, this.hitbox.Size.Height - 8, this.hitbox.Size.Width - 4, this.hitbox.Size.Height - 4);
        }
        ...
        {
            return new Arrow(this.hitbox.Location, this.hitbox.Size, this.border_size, this.color, this.label.Text);
        }
    }
}
