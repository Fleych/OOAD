...
{
    internal class Condition : Element
    {
        public Condition(Point pos, Size element_size, int border_size, Color color, string text)
        {
        ...
        protected override void Draw(object sender, PaintEventArgs e)
        {
            ...
            e.Graphics.DrawLine(pen, this.hitbox.Size.Width / 2, 0, this.hitbox.Size.Width, this.hitbox.Size.Height / 2);
            e.Graphics.DrawLine(pen, this.hitbox.Size.Width, this.hitbox.Size.Height / 2, this.hitbox.Size.Width / 2, this.hitbox.Size.Height);
            e.Graphics.DrawLine(pen, this.hitbox.Size.Width / 2, this.hitbox.Size.Height, 0, this.hitbox.Size.Height / 2);
            e.Graphics.DrawLine(pen, this.border_size, this.hitbox.Size.Height / 2, this.hitbox.Size.Width / 2, 0);
        }
        ...
        {
            return new Condition(this.hitbox.Location, this.hitbox.Size, this.border_size, this.color, this.label.Text);
        }
    }
}
